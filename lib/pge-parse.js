...
exports.parseFile = function(dataFileName, summaryData, allElectric, baselineTerritory, wHPerMile, milesPerDay, earliestDate, latestDate)
{
    var billing_periods = [];
    ...
    console.log('boo',dataFileName, summaryData, allElectric, baselineTerritory, wHPerMile, milesPerDay, earliestDate, latestDate);
    ...
    */
        ...
        bill_parser.parseFile(summaryData);
    }
    ...
    detail_parser.parseFile(dataFileName);
}
