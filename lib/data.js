Object.defineProperty(exports, 'rates',
{
    value : {
        ...
        'E-TOU A': {
            schedule: [
                { start_cal: { month: 'May', day: 1 }, end_cal: { month: 'October', day: 31 }, start_day: 'Monday', end_day: 'Friday', start_time: 15, end_time: 20, type: 'Summer Peak' },
                ...
                { start_cal: { month: 'January', day: 1 }, end_cal: { month: 'April', day: 30 }, start_day: 'Monday', end_day: 'Friday', start_time: 15, end_time: 20, type: 'Winter Peak' },
        ...
        'E-TOU B': {
            schedule: [
                { start_cal: { month: 'May', day: 1 }, end_cal: { month: 'October', day: 31 }, start_day: 'Monday', end_day: 'Friday', start_time: 16, end_time: 21, type: 'Summer Peak' },
                ...
                { start_cal: { month: 'January', day: 1 }, end_cal: { month: 'April', day: 30 }, start_day: 'Monday', end_day: 'Friday', start_time: 16, end_time: 21, type: 'Winter Peak' },
